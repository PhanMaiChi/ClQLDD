...
{
    public partial class NhapTTDV : Office2007Form
    {  
        ...
        private void Luu()
        {
            try
            {
                string sql = "Update ttdv Set dcdv=@dcdv,nlb=@nlb,nnhanhang=@nnhanhang,thukho=@thukho," +
                    " ketoan=@ketoan,kttruong=@kttruong,ttdv=@ttdv,thuquy=@thuquy,MA=@MA,nkxtu=@nkxtu,"+
                    " nkxden=@nkxden,mqhns=@mqhns,diadanh=@diadanh,MASANG=@MASANG,MATOI=@MATOI,MUCHT=@MUCHT,Namhoc=@Namhoc";
        ...
        {
            txtMUCHT1.Text = string.Format("{0:#" + decimalChar + "#}", classdc.dungchung.kieudouble(txtMUCHT1.Text));
            SendKeys.Send("{End}");
        }
        ...
        private void labelX21_Click_1(object sender, EventArgs e)
        {
            tabControl1.SelectPreviousTab();
        }
