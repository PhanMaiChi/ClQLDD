...
namespace KPBT.ThoaiKX
{
    public partial class frmThoaiBaChComth : Office2007Form
    {
        ...
        {
            double kq = 0;
            string sql = "Select Sum([BC]) + sum([BT]) + sum([BC]) as An From baoan where Month(ntan) = '" + cboThang.Text + "' and Year(ntan) = '" + cboNam.Text + "' and mshs = '" + hs + "' and tuanthu = " + Convert.ToInt32(tuan);
