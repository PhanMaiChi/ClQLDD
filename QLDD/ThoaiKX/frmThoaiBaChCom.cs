    ...
    public partial class frmThoaiBaChCom : Office2007Form
    {
        ...
        private void appDC()
        {
            string sql = "insert into TblDC (TEN1,TEN2,TEN3) " +
                ...
                " Group by tenphong, tenhs,mshs,thu" +
        ...
        private string ngaythu(string tuan, string hs, string thu)
        {
            ...
            while (dr.Read())
            {
                kq = classdc.dungchung.thaydoi(dr["ntan"].ToString());
            }
            dr.Close();
            return kq;
        }
        private void upDC()
        {
            ...
            while (dr.Read())
            {
                string sqlup = "Update TblDC set SL1 = @SL1,SL2= @Sl2,SL3=@SL3,SL4=@SL4,SL5=@SL5,"+
                    ...
                    " TEN7=@TEN7,TEN8=@TEN8,TEN9=@TEN9,TEN10=@TEN10 where TEN3 = '" + dr["TEN3"].ToString() + "'";
